...
public class CreateWishlistCommand {
	...
	public CreateWishlistCommand(WishlistId wishlistId, String name, String description, String client, String locale,
			Date createdAt, Source source, Type type, Privacy privacy, String userId, Date modifiedOn) {
		System.out.println(this.getClass().getName() + ": instatiated CreateWishlistCommand");
	...
	public String toString() {
		return "CreateWishlistCommand [wishlistId=" + wishlistId + ", name=" + name + ", description=" + description
